...
// month.
function computeRevenue(counts, metadataById, yieldCmgrById, asOfDate, fyStartMonth, sucStartDate, historicalByKey) {
  ...
  for (const c of counts) {
    ...
    const monthly = monthCols.map((mc, i) => {
      ...
      const rate = sucActive ? (sucPhase === 'cliff' ? sucCliffCmgrRate : sucRecoveryCmgrRate) : cmgrRate;
